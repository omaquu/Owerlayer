...
pub fn setup_overlay_window() {
    ...
    unsafe {
        ...
        // Exclude from capture to prevent feedback loop in Mirror tool
        // WDA_EXCLUDEFROMCAPTURE = 0x00000011 (includes WDA_MONITOR)
        // SetWindowDisplayAffinity(hwnd, 0x00000011); // Removed to allow OBS capture
    }
}
